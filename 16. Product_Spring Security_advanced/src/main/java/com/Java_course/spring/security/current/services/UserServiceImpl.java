...
import com.Java_course.spring.security.current.repositories.*;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	@Transactional
	public com.Java_course.spring.security.current.entities.User findByUsername(String username) {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		com.Java_course.spring.security.current.entities.User user = userRepository.findOneByUsername(username);
		if (user == null) {
